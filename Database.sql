/*
*********************************************************************
Inspired from http://www.mysqltutorial.org, thanks a lot !

Some changes from the original (dates, names, categories)
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`toys_and_models` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
(10145,'2020-08-25','2018-09-02','2020-08-31','Shipped',NULL,205),

(10146,'2018-09-03','2018-09-13','2018-09-06','Shipped',NULL,447),

(10147,'2018-09-05','2018-09-12','2018-09-09','Shipped',NULL,379),

(10148,'2018-09-11','2018-09-21','2018-09-15','Shipped','They want to reevaluate their terms agreement with Finance.',276),

(10149,'2018-09-12','2018-09-18','2018-09-17','Shipped',NULL,487),

(10150,'2018-09-19','2018-09-27','2018-09-21','Shipped','They want to reevaluate their terms agreement with Finance.',148),

(10151,'2018-09-21','2018-09-30','2018-09-24','Shipped',NULL,311),

(10152,'2018-09-25','2018-10-03','2018-10-01','Shipped',NULL,333),

(10153,'2018-09-28','2018-10-05','2018-10-03','Shipped',NULL,141),

(10154,'2018-10-02','2018-10-12','2018-10-08','Shipped',NULL,219),

(10155,'2018-10-06','2018-10-13','2018-10-07','Shipped',NULL,186),

(10156,'2018-10-08','2018-10-17','2018-10-11','Shipped',NULL,141),

(10157,'2018-10-09','2018-10-15','2018-10-14','Shipped',NULL,473),

(10158,'2018-10-10','2018-10-18','2018-10-15','Shipped',NULL,121),

(10159,'2018-10-10','2018-10-19','2018-10-16','Shipped',NULL,321),

(10160,'2018-10-11','2018-10-17','2018-10-17','Shipped',NULL,347),

(10161,'2018-10-17','2018-10-25','2018-10-20','Shipped',NULL,227),

(10162,'2018-10-18','2018-10-26','2018-10-19','Shipped',NULL,321),

(10163,'2018-10-20','2018-10-27','2018-10-24','Shipped',NULL,424),

(10164,'2018-10-21','2018-10-30','2018-10-23','Resolved','This order was disputed, but resolved on 11/1/2003; Customer doesn\'t like the colors and precision of the models.',452),

(10165,'2018-10-22','2018-10-31','2018-12-26','Shipped','This order was on hold because customers\'s credit limit had been exceeded. Order will ship when payment is received',148),

(10166,'2018-10-21','2018-10-30','2018-10-27','Shipped',NULL,462),

(10167,'2018-10-23','2018-10-30',NULL,'Cancelled','Customer called to cancel. The warehouse was notified in time and the order didn\'t ship. They have a new VP of Sales and are shifting their sales model. Our VP of Sales should contact them.',448),

(10168,'2018-10-28','2018-11-03','2018-11-01','Shipped',NULL,161),

(10169,'2018-11-04','2018-11-14','2018-11-09','Shipped',NULL,276),

(10170,'2018-11-04','2018-11-12','2018-11-07','Shipped',NULL,452),

(10171,'2018-11-05','2018-11-13','2018-11-07','Shipped',NULL,233),

(10172,'2018-11-05','2018-11-14','2018-11-11','Shipped',NULL,175),

(10173,'2018-11-05','2018-11-15','2018-11-09','Shipped','Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',278),

(10174,'2018-11-06','2018-11-15','2018-11-10','Shipped',NULL,333),

(10175,'2018-11-06','2018-11-14','2018-11-09','Shipped',NULL,324),

(10176,'2018-11-06','2018-11-15','2018-11-12','Shipped',NULL,386),

(10177,'2018-11-07','2018-11-17','2018-11-12','Shipped',NULL,344),

(10178,'2018-11-08','2018-11-16','2018-11-10','Shipped','Custom shipping instructions sent to warehouse',242),

(10179,'2018-11-11','2018-11-17','2018-11-13','Cancelled','Customer cancelled due to urgent budgeting issues. Must be cautious when dealing with them in the future. Since order shipped already we must discuss who would cover the shipping charges.',496),

(10180,'2018-11-11','2018-11-19','2018-11-14','Shipped',NULL,171),

(10181,'2018-11-12','2018-11-19','2018-11-15','Shipped',NULL,167),

(10182,'2018-11-12','2018-11-21','2018-11-18','Shipped',NULL,124),

(10183,'2018-11-13','2018-11-22','2018-11-15','Shipped','We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.',339),

(10184,'2018-11-14','2018-11-22','2018-11-20','Shipped',NULL,484),

(10185,'2018-11-14','2018-11-21','2018-11-20','Shipped',NULL,320),

(10186,'2018-11-14','2018-11-20','2018-11-18','Shipped','They want to reevaluate their terms agreement with the VP of Sales',489),

(10187,'2018-11-15','2018-11-24','2018-11-16','Shipped',NULL,211),

(10188,'2018-11-18','2018-11-26','2018-11-24','Shipped',NULL,167),

(10189,'2018-11-18','2018-11-25','2018-11-24','Shipped','They want to reevaluate their terms agreement with Finance.',205),

(10190,'2018-11-19','2018-11-29','2018-11-20','Shipped',NULL,141),

(10191,'2018-11-20','2018-11-30','2018-11-24','Shipped','We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.',259),

(10192,'2018-11-20','2018-11-29','2018-11-25','Shipped',NULL,363),

(10193,'2018-11-21','2018-11-28','2018-11-27','Shipped',NULL,471),

(10194,'2018-11-25','2018-12-02','2018-11-26','Shipped',NULL,146),

(10195,'2018-11-25','2018-12-01','2018-11-28','Shipped',NULL,319),

(10196,'2018-11-26','2018-12-03','2018-12-01','Shipped',NULL,455),

(10197,'2018-11-26','2018-12-02','2018-12-01','Shipped','Customer inquired about remote controlled models and gold models.',216),

(10198,'2018-11-27','2018-12-06','2018-12-03','Shipped',NULL,385),

(10199,'2018-12-01','2018-12-10','2018-12-06','Shipped',NULL,475),

(10200,'2018-12-01','2018-12-09','2018-12-06','Shipped',NULL,211),

(10201,'2018-12-01','2018-12-11','2018-12-02','Shipped',NULL,129),

(10202,'2018-12-02','2018-12-09','2018-12-06','Shipped',NULL,357),

(10203,'2018-12-02','2018-12-11','2018-12-07','Shipped',NULL,141),

(10204,'2018-12-02','2018-12-10','2018-12-04','Shipped',NULL,151),

(10205,'2018-12-03','2018-12-09','2018-12-07','Shipped',' I need all the information I can get on our competitors.',141),

(10206,'2018-12-05','2018-12-13','2018-12-08','Shipped','Can we renegotiate this one?',202),

(10207,'2018-12-09','2018-12-17','2018-12-11','Shipped','Check on availability.',495),

(10208,'2019-01-02','2019-01-11','2019-01-04','Shipped',NULL,146),

(10209,'2019-01-09','2019-01-15','2019-01-12','Shipped',NULL,347),

(10210,'2019-01-12','2019-01-22','2019-01-20','Shipped',NULL,177),

(10211,'2019-01-15','2019-01-25','2019-01-18','Shipped',NULL,406),

(10212,'2019-01-16','2019-01-24','2019-01-18','Shipped',NULL,141),

(10213,'2019-01-22','2019-01-28','2019-01-27','Shipped','Difficult to negotiate with customer. We need more marketing materials',489),

(10214,'2019-01-26','2019-02-04','2019-01-29','Shipped',NULL,458),

(10215,'2019-01-29','2019-02-08','2019-02-01','Shipped','Customer requested that FedEx Ground is used for this shipping',475),

(10216,'2019-02-02','2019-02-10','2019-02-04','Shipped',NULL,256),

(10217,'2019-02-04','2019-02-14','2019-02-06','Shipped',NULL,166),

(10218,'2019-02-09','2019-02-16','2019-02-11','Shipped','Customer requested that ad materials (such as posters, pamphlets) be included in the shippment',473),

(10219,'2019-02-10','2019-02-17','2019-02-12','Shipped',NULL,487),

(10220,'2019-02-12','2019-02-19','2019-02-16','Shipped',NULL,189),

(10221,'2019-02-18','2019-02-26','2019-02-19','Shipped',NULL,314),
...
(10225,'2019-02-22','2019-03-01','2019-02-24','Shipped',NULL,298),

(10226,'2019-02-26','2019-03-06','2019-03-02','Shipped',NULL,239),

(10227,'2019-03-02','2019-03-12','2019-03-08','Shipped',NULL,146),

(10228,'2019-03-10','2019-03-18','2019-03-13','Shipped',NULL,173),

(10229,'2019-03-11','2019-03-20','2019-03-12','Shipped',NULL,124),

(10230,'2019-03-15','2019-03-24','2019-03-20','Shipped','Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch',128),

(10231,'2019-03-19','2019-03-26','2019-03-25','Shipped',NULL,344),

(10232,'2019-03-20','2019-03-30','2019-03-25','Shipped',NULL,240),

(10233,'2019-03-29','2019-04-04','2019-04-02','Shipped','Customer requested special shippment. The instructions were passed along to the warehouse',328),

(10234,'2019-03-30','2019-04-05','2019-04-02','Shipped',NULL,412),

(10235,'2019-04-02','2019-04-12','2019-04-06','Shipped',NULL,260),

(10236,'2019-04-03','2019-04-11','2019-04-08','Shipped',NULL,486),

(10237,'2019-04-05','2019-04-12','2019-04-10','Shipped',NULL,181),

(10238,'2019-04-09','2019-04-16','2019-04-10','Shipped',NULL,145),

(10239,'2019-04-12','2019-04-21','2019-04-17','Shipped',NULL,311),

(10240,'2019-04-13','2019-04-20','2019-04-20','Shipped',NULL,177),

(10241,'2019-04-13','2019-04-20','2019-04-19','Shipped',NULL,209),

(10242,'2019-04-20','2019-04-28','2019-04-25','Shipped','Customer is interested in buying more Ferrari models',456),

(10243,'2019-04-26','2019-05-03','2019-04-28','Shipped',NULL,495),

(10244,'2019-04-29','2019-05-09','2019-05-04','Shipped',NULL,141),

(10245,'2019-05-04','2019-05-12','2019-05-09','Shipped',NULL,455),

(10246,'2019-05-05','2019-05-13','2019-05-06','Shipped',NULL,141),

(10247,'2019-05-05','2019-05-11','2019-05-08','Shipped',NULL,334),

(10248,'2019-05-07','2019-05-14',NULL,'Cancelled','Order was mistakenly placed. The warehouse noticed the lack of documentation.',131),

(10249,'2019-05-08','2019-05-17','2019-05-11','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?',173),

(10250,'2019-05-11','2019-05-19','2019-05-15','Shipped',NULL,450),

(10251,'2019-05-18','2019-05-24','2019-05-24','Shipped',NULL,328),

(10252,'2019-05-26','2019-06-04','2019-05-29','Shipped',NULL,406),

(10253,'2019-06-01','2019-06-09','2019-06-02','Cancelled','Customer disputed the order and we agreed to cancel it. We must be more cautions with this customer going forward, since they are very hard to please. We must cover the shipping fees.',201),

(10254,'2019-06-03','2019-06-13','2019-06-04','Shipped','Customer requested that DHL is used for this shipping',323),

(10255,'2019-06-04','2019-06-12','2019-06-09','Shipped',NULL,209),

(10256,'2019-06-08','2019-06-16','2019-06-10','Shipped',NULL,145),

(10257,'2019-06-14','2019-06-24','2019-06-15','Shipped',NULL,450),

(10258,'2019-06-15','2019-06-25','2019-06-23','Shipped',NULL,398),

(10259,'2019-06-15','2019-06-22','2019-06-17','Shipped',NULL,166),

(10260,'2019-06-16','2019-06-22',NULL,'Cancelled','Customer heard complaints from their customers and called to cancel this order. Will notify the Sales Manager.',357),

(10261,'2019-06-17','2019-06-25','2019-06-22','Shipped',NULL,233),

(10262,'2019-06-24','2019-07-01',NULL,'Cancelled','This customer found a better offer from one of our competitors. Will call back to renegotiate.',141),

(10263,'2019-06-28','2019-07-04','2019-07-02','Shipped',NULL,175),

(10264,'2019-06-30','2019-07-06','2019-07-01','Shipped','Customer will send a truck to our local warehouse on 7/1/2004',362),

(10265,'2019-07-02','2019-07-09','2019-07-07','Shipped',NULL,471),

(10266,'2019-07-06','2019-07-14','2019-07-10','Shipped',NULL,386),

(10267,'2019-07-07','2019-07-17','2019-07-09','Shipped',NULL,151),

(10268,'2019-07-12','2019-07-18','2019-07-14','Shipped',NULL,412),

(10269,'2019-07-16','2019-07-22','2019-07-18','Shipped',NULL,382),

(10270,'2019-07-19','2019-07-27','2019-07-24','Shipped','Can we renegotiate this one?',282),

(10271,'2019-07-20','2019-07-29','2019-07-23','Shipped',NULL,124),

(10272,'2019-07-20','2019-07-26','2019-07-22','Shipped',NULL,157),

(10273,'2019-07-21','2019-07-28','2019-07-22','Shipped',NULL,314),

(10274,'2019-07-21','2019-07-29','2019-07-22','Shipped',NULL,379),

(10275,'2019-07-23','2019-08-02','2019-07-29','Shipped',NULL,119),

(10276,'2019-08-02','2019-08-11','2019-08-08','Shipped',NULL,204),

(10277,'2019-08-04','2019-08-12','2019-08-05','Shipped',NULL,148),

(10278,'2019-08-06','2019-08-16','2019-08-09','Shipped',NULL,112),

(10279,'2019-08-09','2019-08-19','2019-08-15','Shipped','Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',141),

(10280,'2019-08-17','2019-08-27','2019-08-19','Shipped',NULL,249),

(10281,'2019-08-19','2019-08-28','2019-08-23','Shipped',NULL,157),

(10282,'2019-08-20','2019-08-26','2019-08-22','Shipped',NULL,124),

(10283,'2019-08-20','2019-08-30','2019-08-23','Shipped',NULL,260),

(10284,'2019-08-21','2019-08-29','2019-08-26','Shipped','Custom shipping instructions sent to warehouse',299),

(10285,'2019-08-27','2019-09-04','2019-08-31','Shipped',NULL,286),

(10286,'2019-08-28','2019-09-06','2019-09-01','Shipped',NULL,172),

(10287,'2019-08-30','2019-09-06','2019-09-01','Shipped',NULL,298),

(10288,'2019-09-01','2019-09-11','2019-09-05','Shipped',NULL,166),

(10289,'2019-09-03','2019-09-13','2019-09-04','Shipped','We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.',167),

(10290,'2019-09-07','2019-09-15','2019-09-13','Shipped',NULL,198),

(10291,'2019-09-08','2019-09-17','2019-09-14','Shipped',NULL,448),

(10292,'2019-09-08','2019-09-18','2019-09-11','Shipped','They want to reevaluate their terms agreement with Finance.',131),

(10293,'2019-09-09','2019-09-18','2019-09-14','Shipped',NULL,249),

(10294,'2019-09-10','2019-09-17','2019-09-14','Shipped',NULL,204),

(10295,'2019-09-10','2019-09-17','2019-09-14','Shipped','They want to reevaluate their terms agreement with Finance.',362),

(10296,'2019-09-15','2019-09-22','2019-09-16','Shipped',NULL,415),

(10297,'2019-09-16','2019-09-22','2019-09-21','Shipped','We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.',189),

(10298,'2019-09-27','2019-10-05','2019-10-01','Shipped',NULL,103),

(10299,'2019-09-30','2019-10-10','2019-10-01','Shipped',NULL,186),

(10300,'2018-10-04','2018-10-13','2018-10-09','Shipped',NULL,128),

(10301,'2018-10-05','2018-10-15','2018-10-08','Shipped',NULL,299),

(10302,'2018-10-06','2018-10-16','2018-10-07','Shipped',NULL,201),

(10303,'2019-10-06','2019-10-14','2019-10-09','Shipped','Customer inquired about remote controlled models and gold models.',484),

(10304,'2019-10-11','2019-10-20','2019-10-17','Shipped',NULL,256),

(10305,'2019-10-13','2019-10-22','2019-10-15','Shipped','Check on availability.',286),

(10306,'2019-10-14','2019-10-21','2019-10-17','Shipped',NULL,187),

(10307,'2019-10-14','2019-10-23','2019-10-20','Shipped',NULL,339),

(10308,'2019-10-15','2019-10-24','2019-10-20','Shipped','Customer requested that FedEx Ground is used for this shipping',319),

(10309,'2019-10-15','2019-10-24','2019-10-18','Shipped',NULL,121),

(10310,'2019-10-16','2019-10-24','2019-10-18','Shipped',NULL,259),

(10311,'2019-10-16','2019-10-23','2019-10-20','Shipped','Difficult to negotiate with customer. We need more marketing materials',141),

(10312,'2019-10-21','2019-10-27','2019-10-23','Shipped',NULL,124),

(10313,'2019-10-22','2019-10-28','2019-10-25','Shipped','Customer requested that FedEx Ground is used for this shipping',202),

(10314,'2019-10-22','2019-11-01','2019-10-23','Shipped',NULL,227),

(10315,'2019-10-29','2019-11-08','2019-10-30','Shipped',NULL,119),

(10316,'2019-11-01','2019-11-09','2019-11-07','Shipped','Customer requested that ad materials (such as posters, pamphlets) be included in the shippment',240),

(10317,'2019-11-02','2019-11-12','2019-11-08','Shipped',NULL,161),

(10318,'2019-11-02','2019-11-09','2019-11-07','Shipped',NULL,157),

(10319,'2019-11-03','2019-11-11','2019-11-06','Shipped','Customer requested that DHL is used for this shipping',456),

(10320,'2019-11-03','2019-11-13','2019-11-07','Shipped',NULL,144),

(10321,'2019-11-04','2019-11-12','2019-11-07','Shipped',NULL,462),

(10322,'2019-11-04','2019-11-12','2019-11-10','Shipped','Customer has worked with some of our vendors in the past and is aware of their MSRP',363),

(10323,'2019-11-05','2019-11-12','2019-11-09','Shipped',NULL,128),

(10324,'2019-11-05','2019-11-11','2019-11-08','Shipped',NULL,181),

(10325,'2019-11-05','2019-11-13','2019-11-08','Shipped',NULL,121),

(10326,'2019-11-09','2019-11-16','2019-11-10','Shipped',NULL,144),

(10327,'2019-11-10','2019-11-19','2019-11-13','Resolved','Order was disputed and resolved on 12/1/04. The Sales Manager was involved. Customer claims the scales of the models don\'t match what was discussed.',145),

(10328,'2019-11-12','2019-11-21','2019-11-18','Shipped','Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch',278),

(10329,'2019-11-15','2019-11-24','2019-11-16','Shipped',NULL,131),

(10330,'2019-11-16','2019-11-25','2019-11-21','Shipped',NULL,385),

(10331,'2019-11-17','2019-11-23','2019-11-23','Shipped','Customer requested special shippment. The instructions were passed along to the warehouse',486),

(10332,'2019-11-17','2019-11-25','2019-11-18','Shipped',NULL,187),

(10333,'2019-11-18','2019-11-27','2019-11-20','Shipped',NULL,129),

(10334,'2019-11-19','2019-11-28',NULL,'On Hold','The outstaniding balance for this customer exceeds their credit limit. Order will be shipped when a payment is received.',144),

(10335,'2019-11-19','2019-11-29','2019-11-23','Shipped',NULL,124),

(10336,'2019-11-20','2019-11-26','2019-11-24','Shipped','Customer requested that DHL is used for this shipping',172),

(10337,'2019-11-21','2019-11-30','2019-11-26','Shipped',NULL,424),

(10338,'2019-11-22','2019-12-02','2019-11-27','Shipped',NULL,381),

(10339,'2019-11-23','2019-11-30','2019-11-30','Shipped',NULL,398),

(10340,'2019-11-24','2019-12-01','2019-11-25','Shipped','Customer is interested in buying more Ferrari models',216),

(10341,'2019-11-24','2019-12-01','2019-11-29','Shipped',NULL,382),

(10342,'2019-11-24','2019-12-01','2019-11-29','Shipped',NULL,114),

(10343,'2019-11-24','2019-12-01','2019-11-26','Shipped',NULL,353),

(10344,'2019-11-25','2019-12-02','2019-11-29','Shipped',NULL,350),

(10345,'2019-11-25','2019-12-01','2019-11-26','Shipped',NULL,103),

(10346,'2019-11-29','2019-12-05','2019-11-30','Shipped',NULL,112),

(10347,'2019-11-29','2019-12-07','2019-11-30','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?',114),

(10348,'2019-11-01','2019-11-08','2019-11-05','Shipped',NULL,458),

(10349,'2019-12-01','2019-12-07','2019-12-03','Shipped',NULL,151),

(10350,'2019-12-02','2019-12-08','2019-12-05','Shipped',NULL,141),

(10351,'2019-12-03','2019-12-11','2019-12-07','Shipped',NULL,324),

(10352,'2019-12-03','2019-12-12','2019-12-09','Shipped',NULL,198),

(10353,'2019-12-04','2019-12-11','2019-12-05','Shipped',NULL,447),

(10354,'2019-12-04','2019-12-10','2019-12-05','Shipped',NULL,323),

(10355,'2019-12-07','2019-12-14','2019-12-13','Shipped',NULL,141),

(10356,'2019-12-09','2019-12-15','2019-12-12','Shipped',NULL,250),

(10357,'2019-12-10','2019-12-16','2019-12-14','Shipped',NULL,124),

(10358,'2019-12-10','2019-12-16','2019-12-16','Shipped','Customer requested that DHL is used for this shipping',141),

(10359,'2019-12-15','2019-12-23','2019-12-18','Shipped',NULL,353),

(10360,'2019-12-16','2019-12-22','2019-12-18','Shipped',NULL,496),

(10361,'2019-12-17','2019-12-24','2019-12-20','Shipped',NULL,282),

(10362,'2020-01-05','2020-01-16','2020-01-10','Shipped',NULL,161),

(10363,'2020-01-06','2020-01-12','2020-01-10','Shipped',NULL,334),

(10364,'2020-01-06','2020-01-17','2020-01-09','Shipped',NULL,350),

(10365,'2020-01-07','2020-01-18','2020-01-11','Shipped',NULL,320),

(10366,'2020-01-10','2020-01-19','2020-01-12','Shipped',NULL,381),

(10367,'2020-01-12','2020-01-21','2020-01-16','Resolved','This order was disputed and resolved on 2/1/2005. Customer claimed that container with shipment was damaged. FedEx\'s investigation proved this wrong.',205),

(10368,'2020-01-19','2020-01-27','2020-01-24','Shipped','Can we renegotiate this one?',124),

(10369,'2020-01-20','2020-01-28','2020-01-24','Shipped',NULL,379),

(10370,'2020-01-20','2020-02-01','2020-01-25','Shipped',NULL,276),

(10371,'2020-01-23','2020-02-03','2020-01-25','Shipped',NULL,124),

(10372,'2020-01-26','2020-02-05','2020-01-28','Shipped',NULL,398),

(10373,'2020-01-31','2020-02-08','2020-02-06','Shipped',NULL,311),

(10374,'2020-02-02','2020-02-09','2020-02-03','Shipped',NULL,333),

(10375,'2020-02-03','2020-02-10','2020-02-06','Shipped',NULL,119),

(10376,'2020-02-08','2020-02-18','2020-02-13','Shipped',NULL,219),

(10377,'2020-02-09','2020-02-21','2020-02-12','Shipped','Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',186),

(10378,'2020-02-10','2020-02-18','2020-02-11','Shipped',NULL,141),

(10379,'2020-02-10','2020-02-18','2020-02-11','Shipped',NULL,141),

(10380,'2020-02-16','2020-02-24','2020-02-18','Shipped',NULL,141),

(10381,'2020-02-17','2020-02-25','2020-02-18','Shipped',NULL,321),

(10382,'2020-02-17','2020-02-23','2020-02-18','Shipped','Custom shipping instructions sent to warehouse',124);
...
(112,'ND748579','2019-08-20','33347.88'),

(114,'GG31455','2020-05-20','45864.03'),

(114,'MA765515','2019-12-15','82261.22'),

(114,'NP603840','2020-05-31','7565.08'),

(114,'NR27552','2019-03-10','44894.74'),

(119,'DB933704','2019-11-14','19501.82'),

(119,'LN373447','2019-08-08','47924.19'),

(119,'NG94694','2020-02-22','49523.67'),

(121,'DB889831','2020-02-16','50218.95'),

(121,'FD317790','2018-10-28','1491.38'),

(121,'KI831359','2019-11-04','17876.32'),

(121,'MA302151','2019-11-28','34638.14'),

(124,'BG255406','2019-08-28','85410.87'),

(124,'CQ287967','2020-04-11','11044.30'),

(124,'HI366474','2019-12-27','47142.70'),

(124,'HR86578','2019-11-02','55639.66'),

(124,'KI131716','2020-08-15','111654.40'),

(124,'LF217299','2019-03-26','43369.30'),

(124,'NT141748','2018-11-25','45084.38'),

(128,'DI925118','2020-01-28','10549.01'),

(128,'FA465482','2018-10-18','24101.81'),

(128,'FH668230','2019-03-24','33820.62'),

(128,'IP383901','2019-11-18','7466.32'),

(129,'DM826140','2019-12-08','26248.78'),

(129,'ID449593','2018-12-11','23923.93'),

(129,'PI42991','2020-04-09','16537.85'),

(131,'CL442705','2020-03-12','22292.62'),

(131,'MA724562','2019-12-02','50025.35'),

(131,'NB445135','2019-09-11','35321.97'),

(141,'AU364101','2020-07-19','36251.03'),

(141,'DB583216','2019-11-01','36140.38'),

(141,'HJ32686','2019-01-30','59830.55'),

(141,'ID10962','2019-12-31','116208.40'),

(141,'JN355280','2018-10-26','49539.37'),

(141,'JN722010','2020-02-25','40206.20'),

(141,'KT52578','2018-12-09','63843.55'),

(141,'MC46946','2019-07-09','35420.74'),

(141,'MF629602','2019-08-16','20009.53'),

(141,'NU627706','2019-05-17','26155.91'),

(144,'IR846303','2019-12-12','36005.71'),

(144,'LA685678','2020-04-09','7674.94'),

(145,'CN328545','2019-07-03','4710.73'),

(145,'ED39322','2019-04-26','28211.70'),

(145,'HR182688','2019-12-01','20564.86'),

(145,'JJ246391','2020-02-20','53959.21'),

(146,'FP549817','2019-03-18','40978.53'),

(146,'FU793410','2019-01-16','49614.72'),

(146,'LJ160635','2018-12-10','39712.10'),

(148,'BI507030','2020-04-22','44380.15'),

(148,'DD635282','2019-08-11','2611.84'),

(148,'KM172879','2018-12-26','105743.00'),

(151,'BF686658','2018-12-22','58793.53'),

(151,'GB852215','2019-07-26','20314.44'),

(151,'IP568906','2020-06-18','58841.35'),

(151,'KI884577','2019-12-14','39964.63'),

(157,'HI618861','2019-11-19','35152.12'),

(157,'NN711988','2019-09-07','63357.13'),

(161,'BR352384','2019-11-14','2434.25'),

(161,'BR478494','2018-11-18','50743.65'),

(161,'KG644125','2020-02-02','12692.19'),

(161,'NI908214','2020-08-05','38675.13'),

(166,'BQ327613','2019-09-16','38785.48'),

(166,'DC979307','2019-07-07','44160.92'),

(166,'LA318629','2019-02-28','22474.17'),

(167,'ED743615','2019-09-19','12538.01'),

(167,'GN228846','2018-12-03','85024.46'),

(171,'GB878038','2019-03-15','18997.89'),

(171,'IL104425','2018-11-22','42783.81'),

(172,'AD832091','2019-09-09','1960.80'),

(172,'CE51751','2019-12-04','51209.58'),

(172,'EH208589','2020-04-20','33383.14'),

(173,'GP545698','2019-05-13','11843.45'),

(173,'IG462397','2019-03-29','20355.24'),

(175,'IO448913','2018-11-19','24879.08'),

(175,'PI15215','2019-07-10','42044.77'),

(177,'AU750837','2019-04-17','15183.63'),

(177,'CI381435','2019-01-19','47177.59'),

(181,'CM564612','2019-04-25','22602.36'),

(181,'GQ132144','2020-01-30','5494.78'),

(181,'OH367219','2019-11-16','44400.50'),

(186,'AK412714','2018-10-27','37602.48'),

(186,'KA602407','2019-10-21','34341.08'),

(187,'AM968797','2019-11-03','52825.29'),

(187,'BQ39062','2019-12-08','47159.11'),

(187,'KL124726','2020-03-27','48425.69'),

(189,'BO711618','2019-10-03','17359.53'),

(189,'NM916675','2019-03-01','32538.74'),

(198,'FI192930','2019-12-06','9658.74'),

(198,'HQ920205','2020-07-06','6036.96'),

(198,'IS946883','2019-09-21','5858.56'),

(201,'DP677013','2018-10-20','23908.24'),

(201,'OO846801','2019-06-15','37258.94'),

(202,'HI358554','2018-12-18','36527.61'),

(202,'IQ627690','2019-11-08','33594.58'),

(204,'GC697638','2019-08-13','51152.86'),

(204,'IS150005','2019-09-24','4424.40'),

(205,'GL756480','2018-12-04','3879.96'),

(205,'LL562733','2018-09-05','50342.74'),

(205,'NM739638','2020-02-06','39580.60'),

(209,'ED520529','2019-06-21','4632.31'),

(209,'PH785937','2019-05-04','36069.26'),

(211,'BJ535230','2018-12-09','45480.79'),

(216,'BG407567','2020-05-09','3101.40'),

(216,'ML780814','2019-12-06','24945.21'),

(216,'MM342086','2018-12-14','40473.86'),

(219,'BR941480','2018-10-18','4465.85'),

(227,'MQ413968','2018-10-31','36164.46'),

(227,'NU21326','2019-11-02','53745.34'),

(233,'II180006','2019-07-01','22997.45'),

(233,'JG981190','2018-11-18','16909.84'),

(239,'NQ865547','2019-03-15','80375.24'),

(240,'IF245157','2019-11-16','46788.14'),

(240,'JO719695','2019-03-28','24995.61'),

(242,'AF40894','2018-11-22','33818.34'),

(242,'KI744716','2020-07-21','14232.70'),

(249,'IJ399820','2019-09-19','33924.24'),

(249,'NE404084','2019-09-04','48298.99'),

(250,'HD284647','2019-12-30','26311.63'),

(250,'HN114306','2020-07-18','23419.47'),

(256,'EP227123','2019-02-10','5759.42'),

(256,'HE84936','2019-10-22','53116.99'),

(259,'EU280955','2019-11-06','61234.67'),

(259,'GB361972','2018-12-07','27988.47'),

(260,'IO164641','2019-08-30','37527.58'),

(260,'NH776924','2019-04-24','29284.42'),

(276,'EM979878','2020-02-09','27083.78'),

(276,'KM841847','2018-11-13','38547.19'),

(276,'LE432182','2018-09-28','41554.73'),

(278,'BJ483870','2019-12-05','37654.09'),

(278,'GP636783','2020-03-02','52151.81'),

(278,'NI983021','2018-11-24','37723.79'),

(282,'IA793562','2020-08-03','24013.52'),

(282,'JT819493','2019-08-02','35806.73'),

(282,'OD327378','2020-01-03','31835.36'),

(286,'DR578578','2019-10-28','47411.33'),

(286,'KH910279','2019-09-05','43134.04'),

(298,'AJ574927','2019-03-13','47375.92'),

(298,'LF501133','2019-09-18','61402.00'),

(299,'AD304085','2018-10-24','36798.88'),

(299,'NR157385','2019-09-05','32260.16'),

(311,'DG336041','2020-02-15','46770.52'),

(311,'FA728475','2018-10-06','32723.04'),

(311,'NQ966143','2019-04-25','16212.59'),

(314,'LQ244073','2019-08-09','45352.47'),

(314,'MD809704','2019-03-03','16901.38'),

(319,'HL685576','2019-11-06','42339.76'),

(319,'OM548174','2018-12-07','36092.40'),

(320,'GJ597719','2020-01-18','8307.28'),

(320,'HO576374','2020-08-20','41016.75'),

(320,'MU817160','2018-11-24','52548.49'),

(321,'DJ15149','2018-11-03','85559.12'),

(323,'ES347491','2019-06-24','37281.36'),

(323,'HG738664','2020-07-05','2880.00'),

(323,'PQ803830','2019-12-24','39440.59'),

(324,'DQ409197','2019-12-13','13671.82'),

(324,'FP443161','2020-07-07','29429.14'),

(324,'HB150714','2018-11-23','37455.77'),

(328,'EN930356','2019-04-16','7178.66'),

(328,'NR631421','2019-05-30','31102.85'),

(333,'HL209210','2018-11-15','23936.53'),

(333,'JK479662','2018-10-17','9821.32'),

(334,'CS435306','2020-01-27','45785.34'),

(334,'HH517378','2020-08-16','29716.86'),

(334,'LF737277','2019-05-22','28394.54'),

(339,'AP286625','2019-10-24','23333.06'),

(339,'DA98827','2018-11-28','34606.28'),

(344,'AF246722','2018-11-24','31428.21'),

(344,'NJ906924','2019-04-02','15322.93'),

(347,'DG700707','2019-01-18','21053.69'),

(347,'LG808674','2018-10-24','20452.50'),

(350,'BQ602907','2019-12-11','18888.31'),

(350,'CI471510','2020-05-25','50824.66'),

(350,'OB648482','2020-01-29','1834.56'),

(353,'CO351193','2020-01-10','49705.52'),

(353,'ED878227','2020-07-21','13920.26'),

(353,'GT878649','2020-05-21','16700.47'),

(357,'AG240323','2018-12-16','20220.04'),

(357,'NB291497','2019-05-15','36442.34'),

(362,'FP170292','2019-07-11','18473.71'),

(362,'OG208861','2019-09-21','15059.76'),

(363,'HL575273','2019-11-17','50799.69'),

(363,'IS232033','2020-01-16','10223.83'),

(363,'PN238558','2018-12-05','55425.77'),

(379,'CA762595','2020-02-12','28322.83'),

(379,'FR499138','2018-09-16','32680.31'),

(379,'GB890854','2019-08-02','12530.51'),

(381,'BC726082','2019-12-03','12081.52'),

(381,'CC475233','2020-04-19','1627.56'),

(381,'GB117430','2020-02-03','14379.90'),

(381,'MS154481','2020-08-22','1128.20'),

(382,'CC871084','2020-05-12','35826.33'),

(382,'CT821147','2019-08-01','6419.84'),

(382,'PH29054','2019-11-27','42813.83'),

(385,'BN347084','2018-12-02','20644.24'),

(385,'CP804873','2019-11-19','15822.84'),

(385,'EK785462','2020-03-09','51001.22'),

(386,'DO106109','2018-11-18','38524.29'),

(386,'HG438769','2019-07-18','51619.02'),

(398,'AJ478695','2020-02-14','33967.73'),

(398,'DO787644','2019-06-21','22037.91'),

(398,'KB54275','2019-11-29','48927.64'),

(406,'HJ217687','2019-01-28','49165.16'),

(406,'NA197101','2019-06-17','25080.96'),

(412,'GH197075','2019-07-25','35034.57'),

(412,'PJ434867','2019-04-14','31670.37'),

(415,'ER54537','2019-09-28','31310.09'),

(424,'KF480160','2019-12-07','25505.98'),

(424,'LM271923','2020-04-16','21665.98'),

(424,'OA595449','2018-10-31','22042.37'),

(447,'AO757239','2018-09-15','6631.36'),

(447,'ER615123','2020-06-25','17032.29'),

(447,'OU516561','2019-12-17','26304.13'),

(448,'KR822727','2019-09-30','48809.90'),

(450,'EF485824','2019-06-21','59551.38'),

(452,'ED473873','2018-11-15','27121.90'),

(452,'FN640986','2018-11-20','15130.97'),

(455,'HA777606','2018-12-05','38139.18'),

(455,'IR662429','2019-05-12','32239.47'),

(456,'GJ715659','2019-11-13','27550.51'),

(456,'MO743231','2019-04-30','1679.92'),

(458,'DD995006','2019-11-15','33145.56'),

(458,'NA377824','2019-02-06','22162.61'),

(458,'OO606861','2020-06-13','57131.92'),

(462,'GC60330','2018-11-08','9977.85'),

(462,'PE176846','2019-11-27','48355.87'),

(471,'AB661578','2019-07-28','9415.13'),

(471,'CO645196','2018-12-10','35505.63'),

(473,'LL427009','2019-02-17','7612.06'),

(473,'PC688499','2018-10-27','17746.26'),

(475,'JP113227','2018-12-09','7678.25'),

(475,'PB951268','2019-02-13','36070.47'),

(484,'GK294076','2019-10-26','3474.66'),

(484,'JH546765','2018-11-29','47513.19'),

(486,'BL66528','2019-04-14','5899.38'),

(486,'HS86661','2019-11-23','45994.07'),
...
(489,'PO860906','2019-01-31','7310.42'),

(495,'BH167026','2018-12-26','59265.14'),

(495,'FN155234','2019-05-14','6276.60'),

(496,'MB342426','2020-07-16','32077.44'),

(496,'MN89921','2019-12-31','52166.00');
...
('S18_2432','1926 Ford Fire Engine','Trucks and Buses','1:18','Carousel DieCast Legends','Gleaming red handsome appearance. Everything is here the fire hoses, ladder, axes, bells, lanterns, ready to fight any inferno.',2019,'24.92','60.77'),
